...
public class QuestionnaireBootstrapper implements Action {
    ...
    private List<QuestionnaireTxt> createQuestionnaires() {
        ...
        QuestionnaireTxt q1 = new QuestionnaireTxt(new QuestionnaireID("1"), new FileName("exemplo1.txt"));
        QuestionnaireTxt q2 = new QuestionnaireTxt(new QuestionnaireID("2"), new FileName("exemplo2.txt"));
        QuestionnaireTxt q3 = new QuestionnaireTxt(new QuestionnaireID("3"), new FileName("exemplo3.txt"));
