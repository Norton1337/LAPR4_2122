...
public class OurGrammarLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "SECTION", "TYPES", "NEWLINE", "INT", 
			"SPACE", "STRING", "QMARK", "LPARENTH", "RPARENTH", "LSQRPARENTH", "RSQRPARENTH", 
			"OPTIONAL", "OBLIGATORY"
		};
	}
	...
	public OurGrammarLexer(CharStream input) {
		super(input);
